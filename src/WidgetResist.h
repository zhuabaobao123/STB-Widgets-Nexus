#pragma once
struct ResistWidget final : RE::IMenu
{
public:

  static constexpr const char* MENU_PATH = "resistWidget";
  static constexpr const char* MENU_NAME = "resistWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new ResistWidget(); }

  auto AdvanceMovie(float interval, uint32_t current_time) -> void override;

private:
  class ResistLogger final : public RE::GFxLog
  {
  public:
