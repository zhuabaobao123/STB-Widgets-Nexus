...
struct WidgetWeight final : RE::IMenu {
public:
  static constexpr const char* MENU_PATH = "weightWidget";
  static constexpr const char* MENU_NAME = "weightWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new WidgetWeight(); }
