...
struct WidgetLvl final : RE::IMenu
{
public:
  static constexpr const char* MENU_PATH = "lvlWidget";
  static constexpr const char* MENU_NAME = "lvlWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new WidgetLvl(); }
