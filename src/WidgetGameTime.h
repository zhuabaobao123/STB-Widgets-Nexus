...
struct WidgetGameTime final : RE::IMenu {
public:
  static constexpr const char* MENU_PATH = "gametimeWidget";
  static constexpr const char* MENU_NAME = "gametimeWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new WidgetGameTime(); }
