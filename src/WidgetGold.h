...
struct WidgetGold final : RE::IMenu {
public:
  static constexpr const char* MENU_PATH = "goldWidget";
  static constexpr const char* MENU_NAME = "goldWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new WidgetGold(); }
