...
struct WidgetShout final : RE::IMenu {
public:
  static constexpr const char* MENU_PATH = "shoutWidget";
  static constexpr const char* MENU_NAME = "shoutWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new WidgetShout(); }
