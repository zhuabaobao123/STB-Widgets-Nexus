...
struct WidgetPlayTime final : RE::IMenu {
public:
  static constexpr const char* MENU_PATH = "playtimeWidget";
  static constexpr const char* MENU_NAME = "playtimeWidget";
  ...
  static auto creator() -> RE::stl::owner<RE::IMenu*> { return new WidgetPlayTime(); }
